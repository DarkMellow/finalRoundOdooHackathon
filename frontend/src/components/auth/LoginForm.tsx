            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <p className="max-w-md text-sm leading-6 text-white/75">
                  Continue managing products, rentals, deposits, and daily operations.
                </p>
              </div>
            </div>
            ...
            <div className="w-full">
              <div className="mb-8">
                ...
                <p className="mt-3 text-sm leading-6 text-[#615d59]">
                  Login to your rental management account.
                </p>
              </div>
              ...
              <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <span className="text-xs text-[#a39e98]">Secure workspace</span>
                </div>
                ...
                <p className="pt-3 text-center text-sm text-[#615d59]">
                  Don&apos;t have an account? <a className="font-semibold text-[#0075de] hover:text-[#005bab]" href="/signup">Sign Up</a>
                </p>
              </form>
            </div>
          </main>
