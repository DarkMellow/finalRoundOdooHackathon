              ...
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <h1 className="max-w-md text-4xl font-bold leading-none tracking-[-1px] text-white">
                    Manage rentals with clarity
                  </h1>
                </div>

                <p className="max-w-md text-sm leading-6 text-white/75">
                  Keep products, customers, deposits, and return dates in one calm workspace.
                </p>
              </div>
            </div>
            ...
            <div className="w-full">
              <div className="mb-8">
                ...
                <p className="mt-3 text-sm leading-6 text-[#615d59]">
                  Set up your workspace to manage rentals and deposits.
                </p>
              </div>
